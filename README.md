...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&size=28&duration=4000&pause=1250&color=20FF86&width=435&lines=i+write+code;i+build+computers;i+solve+problems;i+make+magic;i+miss+you+%3Ac)](https://git.io/typing-svg)
...
Hello world! I'm **Amadeus Gravoso**, a software engineer who specialize in front end development and a creative visual designer based in the Philippines 🇵🇭. Driven by my passion for computers and all things tech, I turn imaginative ideas into practical solutions. 
...
At the moment, I am exploring various front-end technologies and learning the principles of UI and UX design in order to further elevate my craft. As someone who believes in project-based learning, I am currently working on a couple of full-stack projects to better equip myself with industry standard practices. 
